...
ConnMan.prototype.getProperties = function(callback) {
	...
	mgr.GetProperties['timeout'] = 10000;
	if (callback) {
...
ConnMan.prototype.setProperty = function(prop, value, callback) {
	...
	mgr.SetProperty['timeout'] = 10000;
	mgr.SetProperty['error'] = callback || null;
	mgr.SetProperty['finish'] = callback || null;
...
ConnMan.prototype.getTechnologies = function(callback) {
	...
	mgr.GetTechnologies['timeout'] = 10000;
